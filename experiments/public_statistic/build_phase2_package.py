...
def build(output):
    ...
    names += ['runtime/public_statistic/phase2.py','runtime/public_statistic/checkpointing.py','runtime/public_statistic/phase2_execution.py','experiments/public_statistic/run_phase2.py','experiments/public_statistic/build_phase2_package.py','configs/public_luma_phase2_gpu.json','configs/public_luma_phase2_checkpoint_proposal.json','notebooks/public_statistic_phase2_gpu.ipynb','docs/public_statistic/phase2_executable.md','docs/public_statistic/phase2_checkpointing.md']
