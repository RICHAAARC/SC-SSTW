"""Command-line interface for the reusable SC-SSTW four-bit core."""
...
from runtime.wan.integrated_core import generate_video, load_protocol, receive_mp4
...
def main(argv=None):
    ...
    writer.add_argument("--payload", required=True); writer.add_argument("--key", required=True)
    ...
    if args.command == "generate":
        result = generate_video(args.prompt, args.seed, args.payload, args.key.encode(), args.output, protocol, args.arm)
